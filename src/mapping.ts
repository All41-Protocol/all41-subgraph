...
export function handleDepositedState(event: DepositedState): void {
  ...
  //
  // - contract._tradingFeeRate(...)
  // - contract.getAmountInvested(...)
  // - contract.getAmountInvestedWithInterest(...)
  // - contract.getInterestPayable(...)
  // - contract.getOwner(...)
  // - contract.getTradingFeePayable(...)
  // - contract.getcDaiOwned(...)
}
